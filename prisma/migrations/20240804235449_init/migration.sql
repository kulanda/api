...
-- CreateEnum
CREATE TYPE "PaymentType" AS ENUM ('CASH', 'CREDIT_CARD', 'DEBIT_CARD', 'EXPRESS', 'BANK_TRANSFER', 'CHEQUE', 'DEPOSIT');

-- CreateEnum
CREATE TYPE "InvoiceStateType" AS ENUM ('DRAFT', 'ISSUED', 'PAID', 'OVERDUE', 'CANCELLED');

-- CreateEnum
CREATE TYPE "ReceiptStateType" AS ENUM ('ISSUED', 'REVERSED');

-- CreateEnum
CREATE TYPE "CreditNoteStateType" AS ENUM ('DRAFT', 'ISSUED', 'APPLIED', 'CANCELLED');
...
-- CreateTable
CREATE TABLE "suppliers_on_products" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "suppliers_on_products_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "suppliers_on_products" ADD CONSTRAINT "suppliers_on_products_productId_fkey" FOREIGN KEY ("productId") REFERENCES "categories"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "suppliers_on_products" ADD CONSTRAINT "suppliers_on_products_supplierId_fkey" FOREIGN KEY ("supplierId") REFERENCES "suppliers"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "payments" ADD CONSTRAINT "payments_receiptId_fkey" FOREIGN KEY ("receiptId") REFERENCES "sales"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "credit_notes" ADD CONSTRAINT "credit_notes_saleId_fkey" FOREIGN KEY ("saleId") REFERENCES "sales"("id") ON DELETE SET NULL ON UPDATE CASCADE;
