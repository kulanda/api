...
export declare class ServiceService {
    createService(prisma: PrismaClient, { categoryId, storeId, ...dto }: CreateServiceArgs): Promise<ServiceType>;
    editService(prisma: PrismaClient, id: string, dto: EditServiceArgs): Promise<ServiceType>;
